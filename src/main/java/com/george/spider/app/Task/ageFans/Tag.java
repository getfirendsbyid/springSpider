    ...
    public Future<String> start()  {
        ...
        for (int i = 0; i < typeObjects.size(); i++) {
            if (i>2){
                ...
                animeType.setType(typeObjects.get(i).toString());
        ...
        for (int i = 0; i < letterObjects.size(); i++) {
            if (i>2){
                ...
                animeLetter.setLetter(letterObjects.get(i).toString());
        ...
        for (int i = 0; i < seasonObjects.size(); i++) {
            if (i>2){
                ...
                animeSeason.setSeason(seasonObjects.get(i).toString());
        ...
        for (int i = 0; i < statusObjects.size(); i++) {
            if (i>2){
                ...
                animeStatus.setStatus(statusObjects.get(i).toString());
        ...
        for (int i = 0; i < tagObjects.size(); i++) {
            if (i>2){
                ...
                animeTag.setTag(tagObjects.get(i).toString());
